...
import {
  ...
  Building2, Globe, MapPin, Tag, Users, Mail, Lock, Info, Flame,
} from 'lucide-react';
...
const SignUpPage = () => {
  ...
  const setCompetitor = (i: number, val: string) =>
    update('competitors', data.competitors.map((c, idx) => (idx === i ? val : c)));
        ...
        {awaitingConfirmation && (
          <div className="neu rounded-3xl p-8 md:p-10 text-center space-y-4">
            ...
            <p className="text-muted-foreground text-sm max-w-sm mx-auto">
              We sent a confirmation link to <strong className="text-foreground">{data.email}</strong>.
              Click it to verify your account — you'll be taken straight into setup.
            </p>
          </div>
        )}

        {/* Card */}
        {!awaitingConfirmation && <div className="neu rounded-3xl p-8 md:p-10">
                ...
                >
                  <div className="space-y-5">
                    ...
                    <button
                      type="button"
                      onClick={() =>
                        toast({ title: 'Coming soon', description: 'Google sign-in is being set up. Use email for now.' })
                      }
              ...
              {step === 2 && (
                ...
                >
                  <div className="space-y-5">
                    ...
                    <Field label="Website URL" hint="We'll crawl this to score your online presence">
                      <div className="relative">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="rounded-xl border border-primary/20 bg-primary/5 p-4">
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        <p className="text-sm font-semibold">Not sure? Try a high-competition city</p>
                      </div>
                      <p className="text-xs text-muted-foreground mb-3 leading-relaxed">
                        RivalRadar works best where there are real local rivals to benchmark against.
                      </p>
                    ...
                    <div className="flex items-start gap-2 pt-2 text-xs text-muted-foreground border-t border-border/60">
                      ...
                      <p>
                        RivalRadar is purpose-built for <strong className="text-foreground">UK local SEO</strong>.
                        Pick the single town or city you most want to win in.
                      </p>
                    </div>
                  </div>
                </Step>
